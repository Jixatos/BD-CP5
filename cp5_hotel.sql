...
BEGIN
    ...
    INSERT INTO categoria (id_categoria, nome) VALUES (2, 'Econ�mico');
...
BEGIN
    INSERT INTO cliente (cpf, nome, telefone) VALUES ('12345678900', 'Jo�o Silva', '11987654321');
...
BEGIN   
    INSERT INTO colaborador (id_colaborador, nome, cpf, cargo) VALUES (1, 'Lucas Almeida', '98798798700', 'Gerente de Manuten��o');
    ...
    INSERT INTO colaborador (id_colaborador, nome, cpf, cargo) VALUES (5, 'Paulo Rodrigues', '78978912300', 'Seguran�a');
END;
/

BEGIN
    INSERT INTO quarto (numero, status, id_categoria) VALUES (101, 'Dispon�vel', 1);
    INSERT INTO quarto (numero, status, id_categoria) VALUES (102, 'Ocupado', 2);
    INSERT INTO quarto (numero, status, id_categoria) VALUES (103, 'Dispon�vel', 3);
    INSERT INTO quarto (numero, status, id_categoria) VALUES (104, 'Manuten��o', 4);
...
BEGIN
    ...
    INSERT INTO manutencao (id_manutencao, dt_manutencao, descricao, id_colaborador, quarto_numero) 
    VALUES (3, TO_DATE('2023-10-03', 'YYYY-MM-DD'), 'Troca de l�mpadas', 1, 105);
    INSERT INTO manutencao (id_manutencao, dt_manutencao, descricao, id_colaborador, quarto_numero) 
...
BEGIN
    ...
    VALUES (1, TO_DATE('2023-09-20', 'YYYY-MM-DD'), 'Cart�o de Cr�dito', 1200.00, 1);
    INSERT INTO pagamento (id_pagamento, dt_pagamento, tipo_pagamento, valor, id_reserva)
    VALUES (2, TO_DATE('2023-09-21', 'YYYY-MM-DD'), 'Cart�o de D�bito', 850.00, 2);
    INSERT INTO pagamento (id_pagamento, dt_pagamento, tipo_pagamento, valor, id_reserva)
    VALUES (3, TO_DATE('2023-09-22', 'YYYY-MM-DD'), 'Boleto', 1000.00, 3);
    INSERT INTO pagamento (id_pagamento, dt_pagamento, tipo_pagamento, valor, id_reserva)
    VALUES (4, TO_DATE('2023-09-23', 'YYYY-MM-DD'), 'Pix', 950.00, 4);
    INSERT INTO pagamento (id_pagamento, dt_pagamento, tipo_pagamento, valor, id_reserva)
    VALUES (5, TO_DATE('2023-09-24', 'YYYY-MM-DD'), 'Cart�o de Cr�dito', 1300.00, 5);
END;
/
...
BEGIN
    UPDATE quarto
    SET quarto.status = 'EM MANUTEN��O'
...
BEGIN
    DBMS_OUTPUT.PUT_LINE('Relat�rio de Ocupa��o de Quartos');
